angular.module('imageID.controllers').controller('MyFavoritesCtrl', function($scope, $timeout, $state, AuthService, Restangular, WORDPRESS_REST_BASE_URL, $http, $ionicLoading) {
	$scope.data = {};
