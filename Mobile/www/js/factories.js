angular.module('imageID.factories', [])
...
.factory('WpPushServer', function ($http, WORDPRESS_REST_BASE_URL){
  ...
  return {
    ...
    storeDeviceToken: function(type, regId, userId) {

      console.log("Stored token for registered device with data "+ 'device_token=' + regId + '&device_type='+ type);

      $http.post(WORDPRESS_REST_BASE_URL + '/user/' + userId + "/device", $.param({
            "user_id": userId,
            "device_type": type,
            "pn_token" : regId
        }),{
